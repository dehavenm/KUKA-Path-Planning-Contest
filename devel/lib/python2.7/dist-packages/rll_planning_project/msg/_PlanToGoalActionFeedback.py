...
"""autogenerated by genpy from rll_planning_project/PlanToGoalActionFeedback.msg. Do not edit."""
import sys
...
class PlanToGoalActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "rll_planning_project/PlanToGoalActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rll_planning_project/PlanToGoalFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanToGoalActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = rll_planning_project.msg.PlanToGoalFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = rll_planning_project.msg.PlanToGoalFeedback()

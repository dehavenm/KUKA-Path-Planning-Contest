...
"""autogenerated by genpy from rll_planning_project/PlanToGoalActionResult.msg. Do not edit."""
import sys
...
class PlanToGoalActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "rll_planning_project/PlanToGoalActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rll_planning_project/PlanToGoalResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PlanToGoalActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rll_planning_project.msg.PlanToGoalResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rll_planning_project.msg.PlanToGoalResult()

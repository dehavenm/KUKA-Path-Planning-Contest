...
"""autogenerated by genpy from rll_msgs/JobEnvAction.msg. Do not edit."""
import sys
...
class JobEnvAction(genpy.Message):
  _md5sum = "de11d781867764153bdde1882785d9fe"
  _type = "rll_msgs/JobEnvAction"
...
"""
  ...
  _slot_types = ['rll_msgs/JobEnvActionGoal','rll_msgs/JobEnvActionResult','rll_msgs/JobEnvActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JobEnvAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = rll_msgs.msg.JobEnvActionGoal()
      if self.action_result is None:
        self.action_result = rll_msgs.msg.JobEnvActionResult()
      if self.action_feedback is None:
        self.action_feedback = rll_msgs.msg.JobEnvActionFeedback()
    else:
      self.action_goal = rll_msgs.msg.JobEnvActionGoal()
      self.action_result = rll_msgs.msg.JobEnvActionResult()
      self.action_feedback = rll_msgs.msg.JobEnvActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.action_result.result.job.status))
      _x = self.action_result.result.job.status_detail
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.job_data)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.job_data:
        _x = val1.description
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_result.result.job.status,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_result.result.job.status_detail = str[start:end].decode('utf-8')
      else:
        self.action_result.result.job.status_detail = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.job_data = []
      for i in range(0, length):
        ...
        self.action_result.result.job_data.append(val1)
      _x = self
      start = end
      end += 12

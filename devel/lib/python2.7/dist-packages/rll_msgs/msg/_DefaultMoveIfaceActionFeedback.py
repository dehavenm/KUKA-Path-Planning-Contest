...
"""autogenerated by genpy from rll_msgs/DefaultMoveIfaceActionFeedback.msg. Do not edit."""
import sys
...
class DefaultMoveIfaceActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "rll_msgs/DefaultMoveIfaceActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rll_msgs/DefaultMoveIfaceFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DefaultMoveIfaceActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = rll_msgs.msg.DefaultMoveIfaceFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = rll_msgs.msg.DefaultMoveIfaceFeedback()

...
"""autogenerated by genpy from rll_msgs/JobEnvActionResult.msg. Do not edit."""
import sys
...
class JobEnvActionResult(genpy.Message):
  _md5sum = "b0c46fb3fbfd96a9cba1b5af08db17d2"
  _type = "rll_msgs/JobEnvActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rll_msgs/JobEnvResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JobEnvActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rll_msgs.msg.JobEnvResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rll_msgs.msg.JobEnvResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.result.job.status))
      _x = self.result.job.status_detail
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.result.job_data)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.job_data:
        _x = val1.description
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.job.status,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.job.status_detail = str[start:end].decode('utf-8')
      else:
        self.result.job.status_detail = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        self.result.job_data.append(val1)
      return self

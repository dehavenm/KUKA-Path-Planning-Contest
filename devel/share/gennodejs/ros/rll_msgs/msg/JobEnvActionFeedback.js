...
let JobEnvFeedback = require('./JobEnvFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class JobEnvActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new JobEnvFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = JobEnvFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new JobEnvActionFeedback(null);
    ...
    data.feedback = JobEnvFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JobEnvActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = JobEnvFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new JobEnvFeedback()
    }
...
module.exports = JobEnvActionFeedback;

...
let JobEnvGoal = require('./JobEnvGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class JobEnvActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = JobEnvGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JobEnvActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = JobEnvGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new JobEnvGoal()
    }
...
module.exports = JobEnvActionGoal;
